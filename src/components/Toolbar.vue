  ...
  <div class="toolbar">
    ...
    <div class="shape clearfix shape-image" v-if="customize.length">
      ...
      <ul class="clearfix">
        <li
          draggable="true"
          v-for="(item, index) in precustomize"
          v-bind:key="index"
          @dragstart="dragstart($event, item)"
        >
      ...
      <div
        class="shape-header clearfix"
        v-if="customize.length >= 15"
        @click.stop="showAllImage = !showAllImage"
    ...
    <div class="customize-win" v-if="showCustomize">
      <div class="customize-win-header">
        <span>添加自定义图片</span>
        <div
          @click.stop="showCustomize = false"
      ...
      <div class="customize-image">
        <ul>
          ...
          <li @click.stop="showUpload = !showUpload">
            <span
              class="iconfont icon-add"
              style="color:#666;font-size:48px;line-height:44px;text-align:center;cursor:pointer"
            ></span>
          </li>
        </ul>
      </div>
      ...
      shape: [
        {
          ...
          icon: [
            {
              path:
                '<svg style="left: 1px; top: 1px; width: 32px; height: 30px; display: block; position: relative; overflow: hidden;"><g><g></g><g><g transform="translate(0.5,0.5)" style="visibility: visible;"><rect x="1.44" y="7.68" width="28.8" height="14.4" rx="2.16" ry="2.16" fill="#ffffff" stroke="#000000" stroke-width="1.3" pointer-events="all"></rect></g></g><g></g><g></g></g></svg>',
              iconName: "",
            ...
            {
              path:
                '<svg style="left: 1px; top: 1px; width: 32px; height: 30px; display: block; position: relative; overflow: hidden;"><g><g></g><g><g transform="translate(0.5,0.5)" style="visibility: visible;"><ellipse cx="15.98" cy="14.96" rx="13.600000000000001" ry="13.600000000000001" fill="#ffffff" stroke="#000000" stroke-width="1.3" pointer-events="all"></ellipse></g></g><g></g><g></g></g></svg>',
              iconName: "circle",
              text: "圆形",
              command: "circular",
            },
